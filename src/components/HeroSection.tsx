    ...
    <section className=" text-gray-800 md:min-h-screen pt-20">
      <div className="container flex flex-col justify-center py-4 md:p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
        <div className="flex flex-col justify-center py-4 md:p-6 text-center rounded-sm lg:max-w-md xl:max-w-4xl lg:text-left ">
          <div className="space-y-6">
            <h1 className="text-5xl font-medium leading-none sm:text-7xl uppercase">
              Hi im <span className="text-[var(--primary-color)]">Anaf Rafitno</span>
            </h1>
            ...
            IT (Information Technology) adalah bidang yang mencakup penggunaan komputer, perangkat keras, perangkat lunak, dan jaringan untuk mengelola, menyimpan, dan mengirimkan informasi. IT berperan penting dalam mendukung operasional bisnis, komunikasi, serta pengembangan solusi teknologi di berbagai sektor. 
            </p>
        ...
        <div className="flex items-center justify-center py-4 md:p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
          <Image width={'500'} height={'500'} src="/gambar/1.png" alt="" className="object-cover h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128    w-72 sm:w-80 lg:w-96 xl:w-112 2xl:w-128 rounded-full" />
        </div>
      </div>
    </section>
  );
